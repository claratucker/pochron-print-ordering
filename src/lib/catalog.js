...
export function loadCatalog() {
  ...
  const shipZones = db.prepare('SELECT key,label,kind,standard,expedited FROM ship_zones ORDER BY sort').all();
  ...
  return {
    papers, paperById, sizes, prices, shipping, shipZones, volume,
